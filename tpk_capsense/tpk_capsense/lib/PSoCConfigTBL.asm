...
export LoadConfigTBL_tpk_capsense_Bank1
export LoadConfigTBL_tpk_capsense_Bank0
export LoadConfigTBL_tpk_capsense_Ordered
AREA lit(rom, rel)
LoadConfigTBL_tpk_capsense_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_tpk_capsense_Bank1:
;  Instance name CSD_1, User Module CSD
;       Instance name CSD_1, Block Name CMP(ACE01)
;       Instance name CSD_1, Block Name CMP0(ACE00)
;       Instance name CSD_1, Block Name CMP_REF(ASE11)
...
;  Global Register values Bank 1
	...
	db		d8h, 08h		; Port_0_MUXBusCtrl register (MUX_CR0)
	db		d9h, 50h		; Port_1_MUXBusCtrl register (MUX_CR1)
	db		dah, 00h		; Port_2_MUXBusCtrl register (MUX_CR2)
	db		dbh, 00h		; Port_3_MUXBusCtrl register (MUX_CR3)
	db		ffh
AREA psoc_config(rom, rel)
LoadConfigTBL_tpk_capsense_Ordered:
