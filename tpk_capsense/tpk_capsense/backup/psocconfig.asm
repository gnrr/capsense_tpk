...
export LoadConfig_tpk_capsense
export _LoadConfig_tpk_capsense
...
;---------------------------------------------------------------------------
; Load Configuration tpk_capsense
;
;    Load configuration registers for tpk_capsense.
...
;               CUR_PP
;
_LoadConfig_tpk_capsense:
 LoadConfig_tpk_capsense:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_tpk_capsense_Bank0
    mov     X, <LoadConfigTBL_tpk_capsense_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_tpk_capsense_Bank1
    mov     X, <LoadConfigTBL_tpk_capsense_Bank1
